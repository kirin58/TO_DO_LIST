    ...
    <div class="flex flex-col space-y-2 w-full  p-5">
      <div class="flex items-center justify-between" >
        <div class="flex items-center gap-2">
          <button @click="$emit('toggleselectTrash')">
            <i :class="selectTrash ? 'bx bx-checkbox-checked checkbox' : 'bx bx-checkbox checkbox'"></i>
          </button>
          <p class="text-lg text-stone-500">All</p>
        </div>
        <div class="flex items-center gap-2">
          <button @click="$emit('restoreTasks')">
            <i class='bx bx-undo text-3xl text-zinc-400'></i> 
          </button>
          <button @click="$emit('deleteForever')">
            <i class='bx  bx-trash text-2xl text-zinc-400'></i> 
          </button>
        </div>
      </div>
